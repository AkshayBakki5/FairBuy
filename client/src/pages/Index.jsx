...
import { Search, ArrowRight, TrendingUp, ShieldCheck, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-16 md:py-28">
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Search any product and get real-time prices from BigBasket, Blinkit, Zepto, Swiggy Instamart, Flipkart, and Amazon Fresh — all in one place.
          </p>
          ...
          <form onSubmit={handleSearch} className="max-w-xl mx-auto flex gap-2">
            ...
            <Button type="submit" size="lg" className="rounded-2xl px-6 gap-2 shadow-lg">
      ...
      <section className="py-8 border-y bg-card/30">
        <div className="container mx-auto px-4">
          <p className="text-center text-xs text-muted-foreground mb-4 uppercase tracking-widest font-medium">Comparing prices from</p>
          <div className="flex items-center justify-center gap-6 md:gap-10 flex-wrap">
            {STORES.map((store) =>
            <div key={store.id} className="flex items-center gap-1.5 text-sm font-medium text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="rounded-2xl border bg-card p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Live prices scraped directly from store websites — no fake or cached data.</p>
            </div>
            <div className="rounded-2xl border bg-card p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Watch any product and get notified instantly when the price drops.</p>
            </div>
            <div className="rounded-2xl border bg-card p-6 text-center">
              <div className="h-12 w-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-3">
              ...
              <p className="text-sm text-muted-foreground">Buy directly from the cheapest store — we redirect you to the real product page.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t py-8">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          ...
          <p className="mt-1">Compare grocery prices across India's top platforms. Real prices, real savings.</p>
        </div>
      </footer>
    </div>);
